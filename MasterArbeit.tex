...
\begin{figure}[htbp]                                 
 \begin{center}                                       
  \includegraphics[width=0.7\linewidth]{figures/CERNKomplex.jpg} 
...
\end{figure}
%
In the huge accelerator complex protons reach through different stages energies of $\SI{6.5}{\tera\electronvolt}$ and will be brought to collisions at defined buch crossing sites in time intervals of ??ns. Particle detectors then register signatures of the resulting collsion events and the analysis of new created particles gives insight to the nature of elementary particle physics.\newline 
