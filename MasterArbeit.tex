...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter*{Summary}
This thesis gives insight to tau lepton related signal and background efficiencies in the context of searches for pair-produced leptoquarks at the {\ATLAS} experiment. Due to the complex final states of the leptoquark pair decay involving the heaviest quark and heaviest lepton, efficiency studies are performed to increase the understanding of the tau reconstruction efficiencies. This is achieved with a set of two Monte Carlo samples that model the standard model background and two leptoquark signal samples with a mass point of $\SI{500}{\giga\electronvolt}$ and $\SI{1}{\tera\electronvolt}$. Furthermore datasets from the {\ATLAS} data-taking periods in 2015-2018 are used for comparison between data and simulation. To address the final state of the leptoquark pair decay an event selection  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Conclusion}
The tau reconstruction efficiency and fake rate study shows that the background contributions contaminating the potential leptoquark signal in the $t\tau^{-}+\bar{t}\tau^{+}$ can be approximated by contributions mainly from $t\bar{t}$ and $t\bar{t}H$ processes within the chosen event selection. Especially the selection of at least two tau leptons measured data are best resembled by these two background samples.     
% systematics usw miteinbeszeihen .>geanuer, am besten auch weitere background samples
%eff --> aussagen davon: dependencies usw 
% the choosen event selection ist ein guter und wichtiger anfang, aber ist das das ende vom lied->cuts usw dafür braucht man KINEMATICS
% Discovery significance pT und ST sind gut ->weitere gedanken als discriminate variable, mulit parameter für likelihood increase
%OS/SS control region, signal region potential search 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\appendix
%\chapter{Appendix}
