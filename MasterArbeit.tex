...
%%S8 von SSUSYandLQ hat jetzt auch noch generic beschreibung drin, das ist super! Kommt aber eher von dem Standpunkt LQ->models->constraints->exp Suche aber freier->generic models->LQ like SUSY decays
%
\subsection{Leptoquark pair production in proton-proton collisions}\label{LQpp}
%GUT und B anomalies explanation within LQ models --> mal darüber nachdenken, ob man nicht die Kapitelstrukur ändert, ähnlich wie es in der Dr Arbeit LMU ist... das wäre zusammenhängender
