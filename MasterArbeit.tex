...
\begin{figure}
  \centering
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/ttH/Divided_H.pdf}
...
\begin{figure}
  \centering
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ75/Divided_Tau.pdf}
                ...
                %
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ76/Divided_Tau.pdf}
...
\begin{figure}
  \centering
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ75/Divided_LQ.pdf}
...
\begin{figure}
  \centering
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ76/Divided_LQ.pdf}
...
\begin{figure}
  \centering
                ...
                \label{DividedDromLQ:signal:HThadLQ75}
                \end{subfigure}
                %
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ76/Divided_fromLQHT.pdf}
...
\begin{figure}
  \centering
                ...
                %
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ75/Divided_fromLQnjets.pdf}
                ...
                %
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ76/Divided_fromLQnjets.pdf}
...
\end{figure}
%
The minimum and maximum separation for the efficiency selection of taus originating from leptoquarks is depicted in figure \ref{dRFromH:signal:taulepton}.\newline
%
\begin{figure}
  \centering
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ75/Divided_fromLQ_mindR_taulepton.pdf}
                ...
                %
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ75/Divided_maxdR_fromLQ_taulepton.pdf}
                ...
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ76/Divided_fromLQ_mindR_taulepton.pdf}
                ...
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ76/Divided_maxdR_fromLQ_taulepton.pdf}
...
\begin{figure}
  \centering
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ75/Divided_fromLQ_mindR_taujet.pdf}
                ...
                %
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ75/Divided_maxdR_fromLQ_taujet.pdf}
                ...
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ76/Divided_fromLQ_mindR_taujet.pdf}
                ...
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ76/Divided_maxdR_fromLQ_taujet.pdf}
...
\begin{figure}
  \centering
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ75/Divided_mindR_pr_taubjet.pdf}
                ...
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ76/Divided_mindR_pr_taubjet.pdf}
...
\begin{figure}
  \centering
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ75/Divided_mindR_fromLQ_taubjet.pdf}
                ...
                %
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ75/Divided_maxdR_fromLQ_taubjet.pdf}
                ...
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ76/Divided_mindR_fromLQ_taubjet.pdf}
                ...
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.45\textwidth}
                \includegraphics[width=0.95\textwidth]{figures/plots/LQ76/Divided_maxdR_fromLQ_taubjet.pdf}
...
\appendix
\chapter{Appendix}
\section{Comparison between the top-quark background samples (di-lepton versus non-allhadronic)}\label{dilORnonallhad}
