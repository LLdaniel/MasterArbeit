...
\end{figure}
%
Figure \ref{SMpic} summarizes the picture of the Standard Model with its fermions and bosons. The lines indicate, which particles interact with each others trough the mediators, including the self-interaction.
%Gedanken zum SM
