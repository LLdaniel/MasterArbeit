...
Table \ref{SMtable} shows the leptons with selected properties. Various neutrino oscillation experiments confirm that neutrinos have non-zero masses, although the Standard Model does not predict neutrino masses \cite{Kajita}\cite{McDonald} (see chapter \ref{beyondSM}).\newline
\begin{table}[htbp]
		\centering
		\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}cccccc}
		\hline
