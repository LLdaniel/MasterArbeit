...
\begin{figure}
  \centering
                ...
                \subcaption{Efficiency of taus originating from LQs of $\SI{50.7\pm 1.5}{\percent}$ for the high mass LQ events.}
                \label{DividedfromLQ:signal:allLQ76}
                \end{subfigure}
                %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/LQ76/Divided_fromLQ1prong.pdf}
                \subcaption{Efficiency of taus originating from LQs and decaying in the 1-prong mode. The efficiency is $\SI{55.0\pm 1.7}{\percent}$ for the high mass LQ events.}
                \label{DividedfromLQ:signal:1prongLQ76}
                \end{subfigure}
                %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/LQ76/Divided_fromLQ3prong.pdf}
                \subcaption{Efficiency of taus originating from LQs and decaying in the 3-prong mode. The efficiency is $\SI{36.3\pm 3.0}{\percent}$ for the high mass LQ events.}
...
\begin{figure}
  \centering
                ...
                \subcaption{Efficiency of taus originating from leptoquarks depending on $H_{T}$ for the low mass LQ sample.}
                \label{DividedFromLQ:signal:HTLQ75}
                \end{subfigure}
                %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/LQ75/Divided_fromLQHThad.pdf}
                \subcaption{Efficiency of taus originating from leptoquarks depending on $H_{T,\text{had}}$ for the low mass LQ sample.}
                \label{DividedFromLQ:signal:HThadLQ75}
                \end{subfigure}
                %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/LQ76/Divided_fromLQHT.pdf}
                \subcaption{Efficiency of taus originating from leptoquarks depending on $H_{T}$ for the high mass LQ sample.}
                \label{DividedFromLQ:signal:HTLQ76}
                \end{subfigure}
                %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/LQ76/Divided_fromLQHThad.pdf}
                \subcaption{Efficiency of taus originating from leptoquarks depending on $H_{T,\text{had}}$ for the high mass LQ sample.}
...
\begin{figure}
  \centering
                ...
                \subcaption{Efficiency of taus originating from leptoquarks depending on $S_{T}$ for the low mass LQ sample.}
                \label{DividedFromLQ:signal:STLQ75}
                \end{subfigure}
                %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/LQ75/Divided_fromLQSTlep.pdf}
                \subcaption{Efficiency of taus originating from leptoquarks depending on $S_{T,\text{lep}}$ for the low mass LQ sample.}
                \label{DividedFromLQ:signal:STlepLQ75}
                \end{subfigure}
                %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/LQ76/Divided_fromLQST.pdf}
                \subcaption{Efficiency of taus originating from leptoquarks depending on $S_{T}$ for the high mass LQ sample.}
                \label{DividedFromLQ:signal:STLQ76}
                \end{subfigure}
                %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/LQ76/Divided_fromLQSTlep.pdf}
                \subcaption{Efficiency of taus originating from leptoquarks depending on $S_{T,\text{lep}}$ for the high mass LQ sample.}
...
\begin{figure}
  \centering
                ...
                \subcaption{$\cancel{E}_T$ distribution, when selecting at least two b-jets and at least two additional taus.}
                \label{MET:2b2tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/MET_2j1b_1tau.pdf}
                \subcaption{$\cancel{E}_T$ distribution, when selecting at least one b-jet and at least one additional tau.}
                \label{MET:1b1tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/MET_2j1b_2tau.pdf}
                \subcaption{$\cancel{E}_T$ distribution, when selecting at least one b-jet and at least two additional taus.}
                \label{MET:1b2tau}
                \end{subfigure}
...
\begin{figure}
  \centering
                ...
                \subcaption{$H_T$ distribution of the tau leptons, when selecting at least two b-jets and at least two additional taus.}
                \label{HT:2b2tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/HT_2j1b_1tau.pdf}
                \subcaption{$H_T$ distribution of the tau leptons, when selecting at least one b-jet and at least one additional tau.}
                \label{HT:1b1tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/HT_2j1b_2tau.pdf}
                \subcaption{$H_T$ distribution of the tau leptons, when selecting at least one b-jet and at least two additional taus.}
                \label{HT:1b2tau}
                \end{subfigure}
...
\begin{figure}
  \centering
                ...
                \subcaption{$H_{T,\text{had}}$ distribution of the tau leptons, when selecting at least two b-jets and at least two additional taus.}
                \label{HThad:2b2tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/HThad_2j1b_1tau.pdf}
                \subcaption{$H_{T,\text{had}}$ distribution of the tau leptons, when selecting at least one b-jet and at least one additional tau.}
                \label{HThad:1b1tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/HThad_2j1b_2tau.pdf}
                \subcaption{$H_{T,\text{had}}$ distribution of the tau leptons, when selecting at least one b-jet and at least two additional taus.}
                \label{HThad:1b2tau}
                \end{subfigure}
...
\begin{figure}
  \centering
                ...
                \subcaption{$S_T$ distribution of the tau leptons, when selecting at least two b-jets and at least two additional taus.}
                \label{ST:2b2tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/ST_2j1b_1tau.pdf}
                \subcaption{$S_T$ distribution of the tau leptons, when selecting at least one b-jet and at least one additional tau.}
                \label{ST:1b1tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/ST_2j1b_2tau.pdf}
                \subcaption{$S_T$ distribution of the tau leptons, when selecting at least one b-jet and at least two additional taus.}
                \label{ST:1b2tau}
                \end{subfigure}
...
\begin{figure}
  \centering
                ...
                \subcaption{$S_{T,\text{lep}}$ distribution of the tau leptons, when selecting at least two b-jets and at least two additional taus.}
                \label{STlep:2b2tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/STlep_2j1b_1tau.pdf}
                \subcaption{$S_{T,\text{lep}}$ distribution of the tau leptons, when selecting at least one b-jet and at least one additional tau.}
                \label{STlep:1b1tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/STlep_2j1b_2tau.pdf}
                \subcaption{$S_{T,\text{lep}}$ distribution of the tau leptons, when selecting at least one b-jet and at least two additional taus.}
                \label{STlep:1b2tau}
                \end{subfigure}
...
\begin{figure}
  \centering
                ...
                \subcaption{Minimum separation between taus and leptons (electrons and muons), when selecting at least two b-jets and at least two additional taus.}
                \label{mindR:taulepton:2b2tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/mindR_taulepton_2j1b_1tau.pdf}
                \subcaption{Minimum separation between taus and leptons (electrons and muons), when selecting at least one b-jet and at least one additional tau.}
                \label{mindR:taulepton:1b1tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/mindR_taulepton_2j1b_2tau.pdf}
                \subcaption{Minimum separation between taus and leptons (electrons and muons), when selecting at least one b-jet and at least two additional taus.}
...
\begin{figure}
  \centering
                ...
                \subcaption{Maximum separation between taus and leptons (electrons and muons), when selecting at least two b-jets and at least two additional taus.}
                \label{maxdR:taulepton:2b2tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/maxdR_taulepton_2j1b_1tau.pdf}
                \subcaption{Maximum separation between taus and leptons (electrons and muons), when selecting at least one b-jet and at least one additional tau.}
                \label{maxdR:taulepton:1b1tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/maxdR_taulepton_2j1b_2tau.pdf}
                \subcaption{Maximum separation between taus and leptons (electrons and muons), when selecting at least one b-jet and at least two additional taus.}
...
\begin{figure}
  \centering
                ...
                \subcaption{Minimum separation between taus and jets, when selecting at least two b-jets and at least two additional taus.}
                \label{mindR:taujet:2b2tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/mindR_taujet_2j1b_1tau.pdf}
                \subcaption{Minimum separation between taus and jets, when selecting at least one b-jet and at least one additional tau.}
                \label{mindR:taujet:1b1tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/mindR_taujet_2j1b_2tau.pdf}
                \subcaption{Minimum separation between taus and jets, when selecting at least one b-jet and at least two additional taus.}
...
\begin{figure}
  \centering
                ...
                \subcaption{Maximum separation between taus and jets, when selecting at least two b-jets and at least two additional taus.}
                \label{maxdR:taujet:2b2tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/maxdR_taujet_2j1b_1tau.pdf}
                \subcaption{Maximum separation between taus and jets, when selecting at least one b-jet and at least one additional tau.}
                \label{maxdR:taujet:1b1tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/maxdR_taujet_2j1b_2tau.pdf}
                \subcaption{Maximum separation between taus and jets, when selecting at least one b-jet and at least two additional taus.}
...
\begin{figure}
  \centering
                ...
                \subcaption{Minimum separation between taus and b-jets, when selecting at least two b-jets and at least two additional taus.}
                \label{mindR:taubjet:2b2tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/mindR_taubjet_2j1b_1tau.pdf}
                \subcaption{Minimum separation between taus and b-jets, when selecting at least one b-jet and at least one additional tau.}
                \label{mindR:taubjet:1b1tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/mindR_taubjet_2j1b_2tau.pdf}
                \subcaption{Minimum separation between taus and b-jets, when selecting at least one b-jet and at least two additional taus.}
...
\begin{figure}
  \centering
                ...
                \subcaption{Maximum separation between taus and b-jets, when selecting at least two b-jets and at least two additional taus.}
                \label{maxdR:taubjet:2b2tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/maxdR_taubjet_2j1b_1tau.pdf}
                \subcaption{Maximum separation between taus and b-jets, when selecting at least one b-jet and at least one additional tau.}
                \label{maxdR:taubjet:1b1tau}
                \end{subfigure}
                 %
                \begin{subfigure}[t]{0.49\textwidth}
                \includegraphics[width=\textwidth]{figures/plots/kinLQ75/maxdR_taubjet_2j1b_2tau.pdf}
                \subcaption{Maximum separation between taus and b-jets, when selecting at least one b-jet and at least two additional taus.}
