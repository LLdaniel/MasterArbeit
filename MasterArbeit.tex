...
\begin{table}[htbp]
		...
		\\
		\hline
		\rule[-7pt]{0pt}{23pt} Eichboson & \(L_l\) & $B$ & $Q/e$ & $m$/$\frac{\SI{}{\giga\electronvolt}}{\SI{}{\text{\ensuremath{c}\squared}}}$ & Spin $S_z/\hbar$
		\\
		\hline
		...
		\label{SMtable}
	\end{table}
%quarks (baryon -->hadron<->mesons      
%Bosons + kurzer gedanke zu graviton: On elementary particle scales gravity is insignificant compared to all other forces. \cite{Cottingham} außerdem: hypothetisch, falls es eine QFT in verbindung mit ART gäbe
%
