...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Starting point and research question for the analysis}
...
%Zerfallskanäle top tau ...-> aus dem wird ja aufs LQ rückgeschlossen, Verweis auf nächstes chapter https://www-d0.fnal.gov/Run2Physics/top/top_public_web_pages/top_feynman_diagrams.html ttbar tabelle
%als logische Folge zunächst kennenlernen und besser abschäzten:
...
%tau als wichtiges fragezeichen? --> Wie ist das so mit SF usw, für t gibts das, deshalb auch die frage nach der fake rate: was kann alles so ein tau faken. In any case, you are not presenting the full search strategy.  Your work involved mostly in the understanding of the tau reconstruction efficiencies, and the fake rate etc....

%higher lumi
%bezug zu cms <-> counterpart
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
