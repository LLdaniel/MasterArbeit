%%      --- TO DO --- 
%%    Abstand des Chapters zu stark... --> ist aber kein Chapter design problem sondern randproblem des kompletten .tex
...
\begin{figure}[htbp]                                 
 \begin{center}                                       
  \includegraphics[width=0.8\linewidth]{figures/ATLASDesign.png} 
   \caption[Structure of the ATLAS detector and the used coordinate system.]{The layered structure of the ATLAS detector at the LHC and the used cylindric coordinate system. \cite{ATLASJINST}}%Koordinatensystem muss auch R und besser auch eta beinhalten
  \label{ATLASDetector}                                     
 \end{center}
\end{figure}
%
