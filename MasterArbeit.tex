...
\begin{figure}
  \centering
                ...
                \includegraphics[width=\textwidth]{figures/gfa.pdf}
                %\subcaption[]{}
                %\label{}
                \end{minipage}
                %
                \begin{minipage}[t]{0.4\textwidth}
                \includegraphics[width=\textwidth]{figures/gfb.pdf}
                %\subcaption[]{}
                %\label{}
                \end{minipage}
                %
                \begin{minipage}[t]{0.4\textwidth}
                \includegraphics[width=\textwidth]{figures/gfc.pdf}
                %\subcaption[]{}
                %\label{}
                \end{minipage}
                %
                \begin{minipage}[t]{0.4\textwidth}
                \includegraphics[width=\textwidth]{figures/gfd.pdf}
                %\subcaption[]{}
                %\label{}
                \end{minipage}
                %
                \begin{minipage}[t]{0.4\textwidth}
                \includegraphics[width=\textwidth]{figures/qfe.pdf}
                %\subcaption[]{}
                %\label{}
                \end{minipage}
                %
                \begin{minipage}[t]{0.4\textwidth}
                \includegraphics[width=1\textwidth]{figures/qff.pdf}
                %\subcaption[]{}
                %\label{}
                \end{minipage}
%
