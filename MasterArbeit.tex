...
The Standard Model and its various extension possibilities like the Leptoquark Model the third generation quarks i.e. top (t) and bottom (b) play a crucial role due to their large masses \cite{Hansson}. Therefore it is essential to identify hadrons containing b quarks and seperating them from light-flavour quarks at hadron colliders like the LHC. This task is commonly reffered as b-tagging and can be seen as a classification \cite{Paganini}  
%Grundsatzidee:
